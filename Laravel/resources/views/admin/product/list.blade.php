...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
    ...
    <tbody>
        ...
        <tr class="odd gradeX" align="center">
            ...
            <!--     chuyển giá từ dấu , sang dấu chấm. --> 
            <td>    <?php
            ...
            <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="{!!URL::route('admin.product.getDelete', $item['id'])!!}" onclick="return xacNhanXoa('Are you sure to delete this product? ')" > Delete</a></td>
