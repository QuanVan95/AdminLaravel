...
<head>
    ...
    <meta name="author" content="Van Hong Quan">
    ...
    <!-- Nhúng ckeditor và ckfinder cho trang product add -->
    ...
    <!-- END- Nhúng ckeditor và ckfinder cho trang product add -->
...
<body>
    ...
    <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- /.col-lg-12 -->
                        <div class="col-lg-12">
                        <!-- FlashMessage khi thao tác thành công -->
                            @if (Session::has('flash_message'))
                            <div class="alert alert-{!! Session::get('flash_level') !!}">
                                {!! Session::get('flash_message') !!}
                            </div>
                            @endif
                        <!-- END FlashMessage khi thao tác thành công -->
        ...
        <script src="{{ url('public/admin/bower_components/metisMenu/dist/metisMenu.min.js')
    }}"></script>
